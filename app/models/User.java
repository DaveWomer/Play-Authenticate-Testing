...
public class User extends Model implements RoleHolder {
	...
	public static User create(final AuthUser authUser, boolean isAdmin, boolean validateEmail) {
		...
		roleList.add(SecurityRole.findByRoleName(controllers.Application.USER_ROLE));
